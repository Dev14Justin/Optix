      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="py-16">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
            ...
            >
              <div className="mb-6">
                <img src="./logo_optix.png" alt="Logo" className='w-22 h-auto' /><br />
                ...
                <p className="text-gray-300 leading-relaxed mb-6">
                  Ensemble, construisons un avenir plus intelligent et durable, où la technologie et la 
                  data deviennent des leviers de performance et d’impact positif.
          </p>
          <div className="flex space-x-4">
            ...
            >
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300">Intégration IA dans le prossécus métier</a></li>
                <li><a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300">Analyse de Données</a></li>
                <li><a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300">Interpretation de la données</a></li>
                <li><a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300">Commércialisation de insights public anonymisées</a></li>
                <li><a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300">Orientation pour la prise de decision stratégieaues</a></li>
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:equipeoptix@gmail.com"><span className="text-gray-300">equipeoptix@gmail.com</span></a>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <a href="tel:+22870266960"><span className="text-gray-300">+228 70266960</span></a>
                </div>
                <div className="flex items-center space-x-3">
